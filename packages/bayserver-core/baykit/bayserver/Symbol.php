...
class Symbol
{
    ...
    const CFG_NET_MULTIPLEXER_NOT_SUPPORTED = "CFG_NET_MULTIPLEXER_NOT_SUPPORTED";
    const CFG_FILE_MULTIPLEXER_NOT_SUPPORTED = "CFG_FILE_MULTIPLEXER_NOT_SUPPORTED";
    const CFG_LOG_MULTIPLEXER_NOT_SUPPORTED = "CFG_LOG_MULTIPLEXER_NOT_SUPPORTED";
    const CFG_CGI_MULTIPLEXER_NOT_SUPPORTED = "CFG_CGI_MULTIPLEXER_NOT_SUPPORTED";
    const CFG_MULTIPLEXER_NEEDS_A_GRAND_AGENT = "CFG_MULTIPLEXER_NEEDS_A_GRAND_AGENT";
    const CFG_NET_MULTIPLEXER_DOES_NOT_SUPPORT_THIS_RECIPIENT = "CFG_NET_MULTIPLEXER_DOES_NOT_SUPPORT_THIS_RECIPIENT";
    const CFG_SPIN_MULTIPLEXER_NEEDS_SENSOR = "CFG_SPIN_MULTIPLEXER_NEEDS_SENSOR";
    ...
    const HTP_READ_DATA_EXCEEDED = "HTP_READ_DATA_EXCEEDED";
